  ...
  const faqCategories = [
    {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            "Lightning is a faith-based social networking app designed to connect Christians through authentic testimonies and location-based features. Share your faith journey, connect with believers nearby, join groups, and build meaningful relationships.",
        },
        {
          question: "Is Lightning free to use?",
          answer:
            "Yes, Lightning is completely free to use. All core features including messaging, groups, testimonies, and connections are available at no cost.",
        },
      ],
    },
    {
      ...
      faqs: [
        {
          ...
          answer:
            "All profiles on Lightning are public so that believers can find and connect with each other. Your profile is visible to everyone in the app.",
        },
        {
          question: "Who can see my testimony?",
          answer:
            "Your testimony is visible to all users on Lightning. Sharing your story openly helps inspire and encourage others in their faith journey.",
        },
        {
          question: "How do I block someone?",
          answer:
            'Go to the user\'s profile and tap the three dots menu, then select "Block User". Blocked users cannot message you, see your profile, or interact with your content.',
        },
        {
          question: "Is my location data safe?",
          answer:
            'Your exact location is never shared with other users. We only show approximate distance (e.g., "2 miles away") to help you connect with nearby Christians. You can disable location features in Settings.',
        },
      ],
    },
    {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            "Lightning uses a mutual friend system. Both users must accept the connection to become friends. There are no one-way followers - connections are always mutual.",
        },
        {
      ...
      faqs: [
        {
          ...
          answer:
            "Go to the Home tab and tap the + button to start a new conversation. Select a friend from your connections list and type your message. You can only message users you're connected with.",
        },
        {
          question: "How do I create a group?",
          answer:
            "From the Home tab, tap the + button on the server rail to create a new server for your church or community. You can then create channels for different topics and invite friends to join.",
        },
        {
          question: "Can I delete messages?",
          answer:
            "Currently, messages cannot be deleted once sent. Be mindful of what you share. We're working on adding message deletion in a future update.",
        },
        {
          question: "What are group co-leaders?",
          answer:
            "Group creators can promote members to co-leaders. Co-leaders can help manage the group, approve join requests, and moderate content.",
        },
      ],
    },
    {
      ...
      faqs: [
        {
          ...
          answer:
            "Share your personal faith journey - how you came to faith, significant moments with God, challenges you've overcome, and how faith impacts your daily life. Be authentic and honest.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "Yes, other users can like and comment on your testimony to offer encouragement and share how your story impacted them.",
        },
      ],
    },
    {
      ...
      faqs: [
        {
          ...
          answer:
            "Go to Settings > Edit Profile or tap the camera icon on your profile. You can upload a photo or choose an emoji avatar.",
        },
        {
          question: "How do I delete my account?",
          answer:
            "Go to Settings > Account > Delete Account. This will permanently delete your profile, messages, and all data. This action cannot be undone.",
        },
        {
          question: "How do I change notification settings?",
          answer:
            "Go to Settings > Notifications to control which notifications you receive for messages, friend requests, and group activity.",
        },
        {
          question: "Can I use Lightning on multiple devices?",
          answer:
            "Yes! Your account syncs across all devices. Just sign in with the same account on each device.",
        },
      ],
    },
  ];
    ...
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        >
          ...
          {/* Search Bar */}
          <div
            className={`p-4 border-b ${nightMode ? "border-white/10" : "border-slate-200"}`}
          >
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-10 pr-10 py-2 rounded-lg transition-colors ${
                  nightMode
          ...
          <div className="flex-1 overflow-y-auto p-6">
            {filteredFAQs.length === 0 ? (
              <div className="text-center py-8">
                ...
                />
                <p
                  className={`${nightMode ? "text-slate-400" : "text-gray-500"}`}
                >
                    ...
                    >
                      ...
                      >
                        <div className="flex items-center gap-2">
                          ...
                          />
                          <h3
                            className={`font-semibold ${nightMode ? "text-white" : "text-slate-900"}`}
                          >
                            {category.title}
                          </h3>
                        </div>
                        ...
                        {category.faqs.map((faq, faqIndex) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              {isExpanded && (
                                <div
                                  className={`px-4 pb-3 ${nightMode ? "text-slate-300" : "text-gray-600"}`}
                                >
