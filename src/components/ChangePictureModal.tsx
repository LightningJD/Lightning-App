        ...
        >
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="flex flex-col items-center gap-3">
              <div
                className={`w-32 h-32 rounded-full flex items-center justify-center text-6xl overflow-hidden ${
                  nightMode
          ...
          {/* Footer */}
          <div
            className={`p-6 border-t ${nightMode ? "border-white/10" : "border-slate-200"} flex gap-3`}
          >
            <button
              onClick={onClose}
              disabled={isSaving}
