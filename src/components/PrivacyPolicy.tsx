          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <Shield className={`w-6 h-6 ${nightMode ? 'text-white' : 'text-blue-600'}`} />
                <div>
            ...
            <div className="space-y-6">
              <section>
                ...
                <div className="space-y-3">
                  <div>
                    <h4 className={`font-medium mb-2 ${nightMode ? 'text-slate-200' : 'text-slate-800'}`}>
              ...
              <section>
                ...
                <div className="space-y-3">
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    ...
                    <li><strong>To protect rights:</strong> To prevent harm or protect our rights</li>
                    <li><strong>With service providers:</strong> Who help us operate the app (under strict confidentiality)</li>
                  </ul>
                </div>
              </section>
              ...
              <section>
                ...
                <p className="leading-relaxed mb-3">You can control your privacy through:</p>
                <ul className="list-disc pl-6 space-y-2">
                  <li><strong>Profile Privacy:</strong> Make your profile private or public</li>
                  <li><strong>Testimony Visibility:</strong> Choose who can see your testimony</li>
                  <li><strong>Message Settings:</strong> Control who can message you</li>
                  <li><strong>Location Sharing:</strong> Enable or disable location features</li>
                  <li><strong>Blocking:</strong> Block users you don't want to interact with</li>
              ...
              <section>
                ...
                <p className="leading-relaxed">
                  ...
                  we need to retain it for legal obligations.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="leading-relaxed">
                  Lightning is not intended for children under 13. We do not knowingly collect information from
              ...
              <section>
                ...
                <p className="leading-relaxed">
                  ...
                  through the app or by email. Your continued use after changes indicates acceptance of the
                  updated policy.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="leading-relaxed">
                  ...
                  <br /><br />
                  <strong>Email:</strong> privacy@lightningapp.com<br />
                  <strong>Address:</strong> Lightning App, LLC<br />
                  Privacy Officer<br />
                </p>
              </section>
            </div>
