        ...
        >
          ...
          >
            ...
            {showDetails && this.state.error && (
              <div
                className={`mb-6 p-4 rounded-lg text-sm font-mono overflow-auto max-h-40 ${
                  nightMode
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full py-3 px-4 rounded-xl font-semibold transition-all flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white"
              >
