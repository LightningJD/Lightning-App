...
interface CreateChannelDialogProps {
  ...
  isOpen: boolean;
  onClose: () => void;
  onCreate: (name: string, topic: string, categoryId?: string, emojiIcon?: string, isPrivate?: boolean, allowedRoleIds?: string[], slowmodeSeconds?: number) => void;
...
const CreateChannelDialog: React.FC<CreateChannelDialogProps> = ({
  ...
  const handleCreate = async () => {
    ...
    setLoading(true);
    await onCreate(sanitizedName, topic.trim(), categoryId || undefined, emojiIcon || undefined, isPrivate || undefined, isPrivate ? allowedRoleIds : undefined, slowmode || undefined);
    setLoading(false);
    setName('');
    setTopic('');
    setEmojiIcon('');
