          ...
          <div className="flex-1 overflow-y-auto p-6">
            {sent ? (
              <div className="flex flex-col items-center justify-center py-12">
                <CheckCircle
                  className={`w-16 h-16 mb-4 ${nightMode ? "text-green-400" : "text-green-600"}`}
                />
                <h3
                  className={`text-xl font-bold mb-2 ${nightMode ? "text-white" : "text-slate-900"}`}
                >
                  Message Sent!
                </h3>
                <p
                  className={`text-center ${nightMode ? "text-slate-300" : "text-slate-600"}`}
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                >
                  <div className="flex items-start gap-3">
                    <Mail
                      className={`w-5 h-5 mt-0.5 ${nightMode ? "text-blue-400" : "text-blue-600"}`}
                    />
                    <div className="flex-1">
                      <p
                        className={`font-medium mb-1 ${nightMode ? "text-white" : "text-slate-900"}`}
                      >
                        Email Support
                      </p>
                      <p
                        className={`text-sm ${nightMode ? "text-slate-300" : "text-slate-600"}`}
                      >
                        support@lightningapp.com
                      </p>
                      <p
                        className={`text-xs mt-2 ${nightMode ? "text-slate-400" : "text-slate-500"}`}
                      >
                ...
                >
                  ...
                  <ul
                    className={`text-xs space-y-1 ${nightMode ? "text-slate-300" : "text-slate-600"}`}
                  >
                    <li>
