    ...
    >
      ...
      >
        ...
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <Shield className={`w-5 h-5 ${nightMode ? 'text-blue-400' : 'text-blue-600'}`} />
        ...
        <div className="p-6 pt-4 overflow-y-auto" style={{ maxHeight: '50vh' }}>
          <div className={`space-y-4 text-sm ${nightMode ? 'text-white/70' : 'text-black/70'}`}>
            <p className={`font-semibold ${nightMode ? 'text-white' : 'text-black'}`}>
              By participating in the Lightning Ambassador Program, you agree to:
            </p>

            <div className="space-y-3">
              <div className="flex gap-2">
                <span>1.</span>
                <p><strong>Genuine Invitations:</strong> Only share your referral code with real people you personally know or have connected with. Mass distribution or spam is prohibited.</p>
              </div>

              <div className="flex gap-2">
                <span>2.</span>
                <p><strong>No Fake Accounts:</strong> Creating multiple accounts or encouraging others to create accounts solely for referral points is strictly forbidden.</p>
              </div>

              <div className="flex gap-2">
                <span>3.</span>
                <p><strong>Authentic Community:</strong> Your referrals should be people genuinely interested in joining the Lightning community and sharing their faith journey.</p>
              </div>

              <div className="flex gap-2">
                <span>4.</span>
                <p><strong>Fair Play:</strong> Any manipulation of the points system (automated signups, device tricks, etc.) will result in account flagging and point removal.</p>
              </div>
            ...
            <p className={`text-xs mt-4 ${nightMode ? 'text-white/40' : 'text-black/40'}`}>
              Lightning reserves the right to modify these terms, reset points, or revoke ambassador status at any time.
            </p>
          </div>
        </div>
