...
const SettingsMenu: React.FC = () => {
  ...
  return (
    <>
      ...
      />
      <div
        className={`fixed inset-y-0 left-0 w-80 ${nightMode ? "bg-[#0a0a0a]" : "bg-slate-50"} z-50 shadow-2xl animate-in slide-in-from-left duration-300`}
      >
        <div className="flex flex-col h-full">
          ...
          <div className="flex-1 overflow-y-auto px-4 py-4 space-y-3">
            {/* Account Section */}
            <div
              className={`${nightMode ? "bg-white/5" : "bg-white"} rounded-xl border ${nightMode ? "border-white/10" : "border-slate-200"} overflow-hidden`}
            >
              <div
                className={`px-4 py-2 ${nightMode ? "bg-white/5 border-white/10" : "bg-slate-50 border-slate-200"} border-b`}
              >
                <h3
                  className={`text-xs font-semibold ${nightMode ? "text-slate-100" : "text-slate-600"} uppercase tracking-wider`}
                >
                  Account
                </h3>
              </div>
              ...
              >
                <div className="flex items-center gap-3">
                  <Edit3
                    className={`w-5 h-5 ${nightMode ? "text-slate-100" : "text-slate-600"}`}
                  />
              ...
              <MenuItem
                ...
                nightMode={nightMode}
                subtext={
                  userProfile?.spotifyUrl ? "Linked" : "Add a YouTube song"
                }
                onClick={() => {
                  setShowMenu(false);
            ...
            >
              ...
              >
                <h3
                  className={`text-xs font-semibold ${nightMode ? "text-slate-100" : "text-slate-600"} uppercase tracking-wider flex items-center gap-1.5`}
                >
            ...
            >
              ...
              {/* Night Mode Toggle */}
              <div
                className={`px-4 py-3 border-b ${nightMode ? "border-white/10" : "border-slate-200"}`}
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <svg
                      className={`w-4 h-4 ${nightMode ? "text-slate-100" : "text-slate-600"}`}
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                    ...
                    <div>
                      ...
                      <p
                        className={`text-xs ${nightMode ? "text-slate-100" : "text-slate-500"}`}
                      >
              ...
              {/* Search Radius */}
              <div
                className={`px-4 py-4 border-b transition-colors ${nightMode ? "border-white/10 hover:bg-white/5" : "border-slate-100 hover:bg-slate-50"}`}
              >
                <div className="flex items-center gap-3 mb-2">
                  <MapPin
                    className={`w-5 h-5 ${nightMode ? "text-slate-100" : "text-slate-400"}`}
                  />
