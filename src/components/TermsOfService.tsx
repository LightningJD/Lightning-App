    ...
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        >
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <FileText className={`w-6 h-6 ${nightMode ? 'text-white' : 'text-blue-600'}`} />
                <div>
          ...
          {/* Content */}
          <div className={`flex-1 overflow-y-auto p-6 ${nightMode ? 'text-slate-100' : 'text-slate-700'}`}>
            <div className="space-y-6">
              <section>
                <h3 className={`text-lg font-semibold mb-3 ${nightMode ? 'text-white' : 'text-slate-900'}`}>
                  1. Acceptance of Terms
                </h3>
                <p className="leading-relaxed">
                  By accessing and using Lightning ("the App"), you agree to be bound by these Terms of Service.
              ...
              <section>
                ...
                <ul className="list-disc pl-6 space-y-2">
                  <li>Connects Christians based on location and shared faith</li>
                  <li>Facilitates sharing of testimonies and faith experiences</li>
              ...
              <section>
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>Confirm that you own or have rights to share the content</li>
                  <li>Agree that your testimonies may be viewed by other users</li>
                  <li>Understand that you can control privacy settings for your content</li>
                </ul>
              </section>
              ...
              <section>
                ...
                <p className="leading-relaxed">
                  Lightning uses AI to help users generate testimonies. By using this feature, you acknowledge that:
                  AI-generated content is a starting point for your personal story, you are responsible for reviewing
                  and editing AI-generated content, and the final testimony should accurately reflect your faith journey.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="leading-relaxed">
                  Your use of Lightning is subject to our Privacy Policy. We are committed to protecting your personal
                  information and respecting your privacy choices.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="leading-relaxed">
                  Lightning is provided "as is" without warranties of any kind. We do not guarantee continuous,
                  uninterrupted access to the service. We are not responsible for user-generated content or
              ...
              <section>
                ...
                <p className="leading-relaxed">
                  To the maximum extent permitted by law, Lightning and its affiliates shall not be liable for any
              ...
              <section>
                ...
                <p className="leading-relaxed">
                  ...
                  Your continued use of Lightning after changes constitutes acceptance of the new terms.
                </p>
              </section>
