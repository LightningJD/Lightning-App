...
const ProfileEditDialog: React.FC<ProfileEditDialogProps> = ({
  ...
  useEffect(() => {
    ...
    const changed =
      ...
      formData.yearSaved !==
        (profile?.yearSaved ? String(profile.yearSaved) : "") ||
      formData.isBaptized !== (profile?.isBaptized || false) ||
      formData.yearBaptized !==
        (profile?.yearBaptized ? String(profile.yearBaptized) : "") ||
      formData.favoriteVerse !== (profile?.favoriteVerse || "") ||
      formData.favoriteVerseRef !== (profile?.favoriteVerseRef || "") ||
      JSON.stringify(formData.faithInterests) !==
        JSON.stringify(profile?.faithInterests || []) ||
      coordsChanged;
  ...
  const validateForm = () => {
    ...
    if (!formData.displayName.trim()) {
      ...
      const hasLettersOrNumbers = /[a-zA-Z0-9]/.test(
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const sanitizedData = {
        ...
        yearSaved: formData.yearSaved
          ? Number.parseInt(formData.yearSaved)
          : null,
        isBaptized: formData.isBaptized,
        yearBaptized: formData.yearBaptized
          ? Number.parseInt(formData.yearBaptized)
          : null,
        ...
        >
          ...
          <div className="flex-1 overflow-y-auto p-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    <span
                      className={`absolute left-4 top-1/2 -translate-y-1/2 ${nightMode ? "text-slate-100" : "text-slate-500"}`}
                    >
                      @
                    </span>
                    <input
                  ...
                  <p
                    className={`text-xs mt-1 ${nightMode ? "text-slate-100" : "text-slate-500"}`}
                  >
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  />
                  <p
                    className={`text-xs mt-2 ${nightMode ? "text-slate-100" : "text-slate-500"}`}
                  >
                    {formData.avatarUrl
                      ? "Your profile picture is set"
                      : "Or use an emoji avatar below"}
                  </p>
                </div>
                ...
                <div>
                  ...
                  <div
                    className={`mt-3 p-3 rounded-lg border text-center ${nightMode ? "bg-white/5 border-white/10" : "bg-blue-50 border-blue-200"}`}
                  >
                    <span
                      className={`text-sm ${nightMode ? "text-slate-100" : "text-slate-700"}`}
                    >
                      Preview:{" "}
                      <span className="text-3xl ml-2">{formData.avatar}</span>
                    </span>
                  </div>
                </div>
              </div>
            ...
            {profile?.hasTestimony && (
              ...
              >
                <div className="flex items-center gap-2 mb-4">
                  <Book
                    className={`w-5 h-5 ${nightMode ? "text-slate-100" : "text-slate-700"}`}
                  />
                  <h3
                ...
                <div className="mb-4">
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      handleInputChange("testimonyContent", e.target.value)
                    }
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      handleInputChange("testimonyLesson", e.target.value)
                    }
            ...
            >
              <div className="flex items-center gap-2 mb-4">
                ...
                <span
                  className={`text-xs px-2 py-0.5 rounded-full ${nightMode ? "bg-blue-500/20 text-blue-400" : "bg-blue-100 text-blue-600"}`}
                >
                  Optional
                </span>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                ...
                <div>
                  <label
                    htmlFor="church-name"
                    className={`block text-sm font-medium mb-1.5 ${nightMode ? "text-slate-300" : "text-slate-700"}`}
                  >
                    Church Name
                  </label>
                  <input
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("yearSaved" as any, e.target.value)
                    }
                    placeholder="2019"
                    min="1900"
                ...
                <div className="lg:col-span-2 flex items-center gap-4">
                  <label
                    htmlFor="is-baptized"
                    className={`flex items-center gap-2 cursor-pointer ${nightMode ? "text-slate-300" : "text-slate-700"}`}
                  >
                    <input
                      id="is-baptized"
                      type="checkbox"
                  ...
                  {formData.isBaptized && (
                    <input
                      ...
                      onChange={(e) =>
                        handleInputChange("yearBaptized" as any, e.target.value)
                      }
                ...
                <div className="lg:col-span-2">
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      handleInputChange("favoriteVerse" as any, e.target.value)
                    }
                ...
                <div className="lg:col-span-2">
                  <span
                    className={`block text-sm font-medium mb-2 ${nightMode ? "text-slate-300" : "text-slate-700"}`}
                  >
                    Faith Interests
                  </span>
                  <div className="flex flex-wrap gap-2">
                    {[
                      ...
                      const isSelected =
                        formData.faithInterests.includes(interest);
                      return (
                        <button
                          key={interest}
                          type="button"
          ...
          >
            ...
            {!hasChanges && Object.keys(errors).length === 0 && (
              <div
                className={`mb-3 text-sm text-center ${nightMode ? "text-slate-400" : "text-slate-500"}`}
              >
                No changes to save
              </div>
            )}
