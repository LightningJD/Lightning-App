    ...
    Tables: {
      ...
      channel_message_reactions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "channel_message_reactions_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      channel_messages: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "channel_messages_pinned_by_fkey"
            columns: ["pinned_by"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      server_channels: {
        ...
        Relationships: [
          {
            foreignKeyName: "server_channels_category_id_fkey"
            columns: ["category_id"]
            isOneToOne: false
            referencedRelation: "server_categories"
            referencedColumns: ["id"]
          },
          {
      ...
      server_join_requests: {
        ...
        Relationships: [
          {
            foreignKeyName: "server_join_requests_server_id_fkey"
            columns: ["server_id"]
            isOneToOne: false
            referencedRelation: "servers"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "server_join_requests_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      server_role_permissions: {
        Row: {
          ban_members: boolean | null
          create_invite: boolean | null
          created_at: string | null
          delete_messages: boolean | null
          id: string
          kick_members: boolean | null
          manage_channels: boolean | null
          manage_members: boolean | null
          manage_roles: boolean | null
          manage_server: boolean | null
        ...
        Relationships: [
          {
            foreignKeyName: "server_role_permissions_role_id_fkey"
            columns: ["role_id"]
            isOneToOne: true
            referencedRelation: "server_roles"
            referencedColumns: ["id"]
      ...
      testimony_generations: {
        ...
        Relationships: [
          {
            foreignKeyName: "testimony_generations_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
